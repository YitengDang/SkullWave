...
save_folder = "/Users/dang/Documents/Projects/Tabler_skull/Data_Live_Imaging/211223 BAPN E14.0 live imaging/Processed_TXT_data_interface/";
for (i = 0; i < nSlices; i++) {
	t = i;
	run("Analyze Particles...", "size=150000-Infinity clear add slice");
	roiManager("Select", 0);
